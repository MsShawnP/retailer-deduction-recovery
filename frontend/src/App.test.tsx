...
function makeDeduction(overrides: Partial<Deduction> = {}): Deduction {
  return {
    ...
    remittance_description: "Short ship",
    amount: 2500,
    ...
    pack_record: {
      ...
      pack_verification: "paper-note",
      evidence_format: "paper-note",
      evidence_location: null,
      evidence_retrieval_minutes: 45,
      packer_initials: "JD",
      units_picked: 100,
      units_packed: 100,
